...
for (const element of usersList) {
    ...
    streetDiv.innerText = element.address.street
    let suiteDiv = document.createElement('div');
    suiteDiv.innerText = element.address.suite
    let cityDiv = document.createElement('div');
    cityDiv.innerText = element.address.city
    let zipcodeDiv = document.createElement('div');
    zipcodeDiv.innerText = element.address.zipcode
    ...
    latDiv.innerText = element.address.geo.lat
    let lngDiv = document.createElement('div');
    lngDiv.innerText = element.address.geo.lng
    ...
    nameCompanyDiv.innerText = element.company.name
    let catchPhraseDiv = document.createElement('div');
    catchPhraseDiv.innerText = element.company.catchPhrase
    let bsDiv = document.createElement('div');
    bsDiv.innerText = element.company.bs
    companyDiv.append(nameCompanyDiv, catchPhraseDiv, bsDiv)

    divBloc.append(idDiv, nameDiv, usernameDiv, emailDiv, addressDiv, phoneDiv, websiteDiv, companyDiv)
